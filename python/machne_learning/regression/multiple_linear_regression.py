...
(x_train_gender,x_test_gender,y_train_gender,y_test_gender)=train_test_split(csv_without_gender_dframe,gender_dframe,random_state=0,test_size=0.33)
...
(x_train_height,x_test_height,y_train_height,y_test_height)=train_test_split(csv_without_height_dframe,height_dframe,random_state=0,test_size=0.33)
#   END
